...
@section('content')
    <div class="max-w-2xl">
        ...
        <div class="bg-white rounded-xl shadow-sm p-6">
            <form method="POST" action="{{ route('admin.apprenants.update', $apprenant) }}">
                @csrf
                @method('PUT')
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="nom" id="nom" value="{{ old('nom', $apprenant->nom) }}"
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="prenom" id="prenom" value="{{ old('prenom', $apprenant->prenom) }}"
                           class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-500 focus:border-transparent
                ...
                <div class="mb-4">
                    ...
                    <input type="email" name="email" id="email" value="{{ old('email', $apprenant->email) }}"
                           class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-500 focus:border-transparent
